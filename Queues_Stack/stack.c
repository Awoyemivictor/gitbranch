...
int push(struct stack* stackPtr, int value)
{
	...
	if (full(stackPtr))
		return 0;
	// Add value to the top of the stack and adjst the value of the top.
...
Post-condiition: The value on the top of the stack is popped and returned
Note: If the stack pointed to by stackPtr is empy, -1 is returned.
*/
